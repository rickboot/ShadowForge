...
import { runBlockBasedPipeline } from '@/lib/conversion/runBlockBasedPipeline';

describe('runBlockBasedPipeline', () => {
    const sampleInput = `
...
`.trim();
    ...
    test('should process blocks and return convertedText and tokenUsage', async () => {
        const result = await runBlockBasedPipeline(sampleInput, 'test-adventure-id');
